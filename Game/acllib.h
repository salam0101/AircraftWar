...
typedef void(*KeyboardEventCallback) (int key, int event,void* param);
typedef void(*CharEventCallback) (char c);
typedef void(*MouseEventCallback) (int x, int y, int button, int event);
typedef void(*TimerEventCallback) (int timerID,void*param);
...
extern "C" {
	...
	void registerKeyboardEvent(KeyboardEventCallback callback,void*param);
	void registerCharEvent(CharEventCallback callback);
	void registerMouseEvent(MouseEventCallback callback);
	void registerTimerEvent(TimerEventCallback callback,void*param);
